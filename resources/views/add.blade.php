...
@section('content')
    ...
    <div class="row">
        ...
        <form method="post" action="{{ route('pets.add') }}">
            @csrf
            <div class="form-group mb-3">
                <label for="id">ID</label>
                <input type="text" class="form-control" id="id" name="id" placeholder="ID" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
            </div>
